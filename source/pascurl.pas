...
type
  ...
  private
    FHandle : CURL;
    FErrorStack : TSession.TErrorStack;
    FBuffer : TMemoryStream;
...
constructor TResult.Create (AValue : VALUE_TYPE; AError : ERROR_TYPE; AOk :
  Boolean);
begin
  FOk := AOk;
...
begin
  ...
  begin
    raise Exception.Create('Impossible value');
  end;
end;
...
begin
  ...
  begin
    raise Exception.Create('Impossible error');
  end;
end;
...
begin
  ...
  FErrorStack := TSession.TErrorStack.Create;
